    ...
    <div className="relative md:hidden">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <Link to="/">হোমপেজ</Link>
            <Link to="https://www.training.oylkka.com/best-computer-training-center/notice">নোটিশ</Link>
            <Link to="/course">কোর্স সমূহ</Link>
            <Link
              to="https://www.training.oylkka.com/best-computer-training-center/application"
              target="__blank"
            >
              আবেদন করুন
            </Link>
