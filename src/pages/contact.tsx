			...
			<div className="mx-auto max-w-6xl">
				...
				<div className="grid grid-cols-1 gap-6 md:grid-cols-3">
					...
					<div className="group rounded-2xl border border-purple-200 bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-purple-100">
						<div className="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-purple-100 to-purple-50 transition-transform group-hover:scale-110">
					...
					<div className="group rounded-2xl border border-cyan-200 bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-cyan-100">
						<div className="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-100 to-cyan-50 transition-transform group-hover:scale-110">
				...
				{/* Info Banner */}
				<div className="mt-16 rounded-2xl bg-gradient-to-r from-purple-50 to-cyan-50 p-8 md:p-12">
					<div className="text-center">
						<h3 className="mb-2 text-2xl font-bold text-gray-900">
							আমাদের সাথে যোগাযোগ করতে প্রস্তুত?
						</h3>
						<p className="text-gray-600">
							যেকোনো সমস্যা বা প্রশ্নের জন্য আমরা সবসময় আপনার সেবায় নিয়োজিত। নির্দ্বিধায় আমাদের সাথে যোগাযোগ করুন।
						</p>
					</div>
				</div>
			</div>
