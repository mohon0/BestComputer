...
import { FaAward, FaChartLine, FaFileWord, FaLaptop, FaPalette, FaUsers } from 'react-icons/fa';
...
export default function AboutPage() {
    ...
    <Layout>
		...
		<main>
			{/* Hero Section */}
			<section className="bg-gradient-to-r from-purple-50 to-cyan-50 px-4 py-20 md:py-32">
				<div className="mx-auto max-w-5xl">
					<h1 className="text-balance text-5xl font-bold text-gray-900 md:text-6xl">
						ওয়েল্কা ট্রেনিং সেন্টার
					</h1>
					<p className="mt-6 text-xl text-gray-600">
						আমরা বাংলাদেশের শীর্ষস্থানীয় আইটি প্রশিক্ষণ কেন্দ্র যেখানে আপনার দক্ষতা উন্নয়ন এবং ক্যারিয়ার গঠনের জন্য সর্বোত্তম শিক্ষা প্রদান করি।
					</p>
				</div>
			</section>
					...
					<div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
						<div>
							...
							<p className="mt-6 text-lg leading-relaxed text-gray-600">
								ওয়েল্কা ট্রেনিং সেন্টার প্রতিষ্ঠিত হয়েছে শিক্ষার্থীদের আধুনিক প্রযুক্তি এবং ডিজিটাল দক্ষতা প্রদান করার লক্ষ্যে। আমরা বিশ্বাস করি যে প্রতিটি শিক্ষার্থীর সফলতার সম্ভাবনা রয়েছে এবং সঠিক নির্দেশনা ও প্রশিক্ষণের মাধ্যমে তা বাস্তবায়ন সম্ভব।
							</p>
							<p className="mt-4 text-lg leading-relaxed text-gray-600">
								আমাদের অভিজ্ঞ প্রশিক্ষক দল এবং আধুনিক শিক্ষা পদ্ধতি শিক্ষার্থীদের ব্যবহারিক দক্ষতা অর্জনে সহায়তা করে। আমরা শুধুমাত্র তত্ত্ব নয়, বরং বাস্তব জগতের অভিজ্ঞতা প্রদান করি।
							</p>
						</div>
				...
				<div className="mx-auto max-w-6xl">
					<div className="mb-12 text-center">
						...
						<p className="mt-4 text-lg text-gray-600">
							আমরা অফার করি বিভিন্ন ক্ষেত্রে বিশেষায়িত কোর্স যা আপনার ক্যারিয়ারকে নতুন উচ্চতায় নিয়ে যেতে পারে।
						</p>
					</div>
					...
					<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
						...
						<div className="rounded-2xl border border-purple-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:shadow-purple-200">
							...
							<h3 className="text-xl font-bold text-gray-900">ওয়েব ডেভেলপমেন্ট</h3>
						...
						<div className="rounded-2xl border border-cyan-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-200">
							...
							<h3 className="text-xl font-bold text-gray-900">গ্রাফিক্স ডিজাইন</h3>
							<p className="mt-3 text-gray-600">
						...
						<div className="rounded-2xl border border-purple-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:shadow-purple-200">
							...
							<h3 className="text-xl font-bold text-gray-900">অফিস অ্যাপ্লিকেশন</h3>
							<p className="mt-3 text-gray-600">
						...
						<div className="rounded-2xl border border-cyan-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-200">
							...
							<h3 className="text-xl font-bold text-gray-900">ডিজিটাল মার্কেটিং</h3>
							<p className="mt-3 text-gray-600">
						...
						<div className="rounded-2xl border border-purple-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:shadow-purple-200">
							...
							<h3 className="text-xl font-bold text-gray-900">ডাটাবেস ম্যানেজমেন্ট</h3>
							<p className="mt-3 text-gray-600">
						...
						<div className="rounded-2xl border border-cyan-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-200">
							...
							<h3 className="text-xl font-bold text-gray-900">মোবাইল অ্যাপ ডেভেলপমেন্ট</h3>
							<p className="mt-3 text-gray-600">
				...
				<div className="mx-auto max-w-5xl">
					...
					<div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
						<div className="flex gap-4">
							...
							<div>
								<h3 className="text-lg font-bold text-gray-900">অভিজ্ঞ প্রশিক্ষক</h3>
						...
						<div className="flex gap-4">
							...
							<div>
								<h3 className="text-lg font-bold text-gray-900">আধুনিক পাঠ্যক্রম</h3>
								<p className="mt-2 text-gray-600">
						...
						<div className="flex gap-4">
							...
							<div>
								<h3 className="text-lg font-bold text-gray-900">ব্যবহারিক প্রশিক্ষণ</h3>
								<p className="mt-2 text-gray-600">
						...
						<div className="flex gap-4">
							...
							<div>
								<h3 className="text-lg font-bold text-gray-900">চাকরির সহায়তা</h3>
								<p className="mt-2 text-gray-600">
						...
						<div className="flex gap-4">
							...
							<div>
								<h3 className="text-lg font-bold text-gray-900">সার্টিফিকেশন</h3>
								<p className="mt-2 text-gray-600">
			...
			{/* CTA Section */}
			<section className="bg-gradient-to-r from-purple-600 to-cyan-600 px-4 py-16 md:py-24">
