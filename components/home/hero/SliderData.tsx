...
import slide1 from "@/assets/icon.png";
...
export const contentData = [
  ...
  {
    img: slide2,
    title: "কারিগরি শিক্ষা বোর্ড কতৃক পরীক্ষার মাধ্যমে সরকারী সার্টিফিকেট প্রদান করা হয়",
    description: "ঝিনাইদহে একমাত্র নির্ভরযোগ্য প্রতিষ্ঠান।",
  },
  {
    img: slide3,
    title: "আধুনিক ও সুসজ্জিত মাল্টিমিডিয়া কম্পিউটার ল্যাব",
    description:
