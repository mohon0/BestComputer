  ...
  return (
    ...
    >
      ...
      >
        <div className="flex h-full flex-col items-center justify-between px-6 py-10">
          ...
          <div className="flex gap-5">
            <button
              type="button"
              className="rounded border bg-white p-2  font-bold text-orange-600 shadow-lg transition-all duration-300 hover:bg-primary-300 hover:text-white"
            >
              আরও জানুন
            </button>
            <button
      ...
      <div className="relative">
        <Image src={img} alt="Course Image" className="w-full object-cover" />
        <div
