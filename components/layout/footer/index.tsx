...
const ContactItem: React.FC<ContactItemProps> = ({ icon, title, details }) => (
  <div className="flex items-start gap-4 group">
    <div className="shrink-0 rounded-full bg-white/10 p-3 transition-all duration-300 group-hover:bg-white/20 group-hover:scale-110">
      {icon}
    </div>
    <div>
      ...
      <div className="space-y-1 text-sm text-white/80">
        {details.map((line, index) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: this is fine for static content
          ...
          <div className="mx-auto max-w-6xl px-4 py-16">
            ...
            <div className="text-center mb-12">
              ...
              <div className="flex justify-center mb-4">
                <div className="h-1.5 w-20 rounded-full bg-linear-to-r from-purple-500 to-cyan-500"></div>
              </div>
