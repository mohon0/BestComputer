...
export default function NotFoundPage() {
	return (
		<>
			...
			<div className="my-28 flex w-full flex-col items-center justify-center space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0">
				<div className="flex w-full flex-col items-center justify-center text-center lg:w-1/2 lg:px-2 xl:px-0">
					...
					<Link href="/" title="Return Home">
						<button
							type="button"
							className="flex items-center rounded-md border bg-primary-100 px-4 py-2 font-bold text-white"
						>
